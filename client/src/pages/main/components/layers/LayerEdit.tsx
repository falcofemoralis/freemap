  ...
  const completeDrawing = () => {
    ...
    switch (editorStore.selectedFeatureType?.geometry) {
      case GeometryType.POLYGON:
        editorStore.newFeatureCoordinates = toTuple((editorStore.newFeature?.getGeometry() as Polygon).getCoordinates(), GeometryType.POLYGON);
        break;
      case GeometryType.LINE_STRING:
        editorStore.newFeatureCoordinates = toTuple((editorStore.newFeature?.getGeometry() as LineString).getCoordinates(), GeometryType.LINE_STRING);
        break;
      case GeometryType.MULTI_POLYGON:
        // TODO FIX TO MULTI_POLYGON !!!!!!!!!!!!!!!!!!!!!!!!!!!
        editorStore.newFeatureCoordinates = toTuple((editorStore.newFeature?.getGeometry() as MultiLineString).getCoordinates(), GeometryType.MULTI_POLYGON);
        break;
    }
